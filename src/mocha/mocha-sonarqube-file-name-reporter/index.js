...
module.exports = function (runner, options) {
    ...
    var filenameFormatter = undefined;
    ...
    if (options && options.reporterOptions && options.reporterOptions.filenameFormatter) {
        filenameFormatter = options.reporterOptions.filenameFormatter;
    }
    ...
    runner.on('end', function () {
        ...
        Object.keys(stack).forEach(function (file) {
            append(util.format('<file path="%s">', (filenameFormatter && filenameFormatter(file)) || file));
